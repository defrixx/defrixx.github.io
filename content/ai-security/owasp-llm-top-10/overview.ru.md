...
- Он не задает production baseline мер контроля; за мерами контроля, приоритетами внедрения и сигналами проверки используйте [обзор безопасности AI](../securing-ai/overview.ru.md).
