# Secure Coding and Code Review Playbook
...
Out of scope:
- abuse of intended product behavior: use the [Business Logic Abuse playbook](../../business-logic/business-logic-abuse/playbook.en.md);
- OAuth/OIDC protocol and token architecture: use the [OIDC + OAuth 2.0 security guide](../../identity/oidc-oauth/playbook.en.md);
- browser-only controls such as CSP, CORS, cookies, and frontend supply chain: use the [browser and frontend security playbook](../../web/browser-security/playbook.en.md);
- API protocol patterns across REST, SOAP/XML, GraphQL, Webhooks, and gRPC: use the [API security playbook](../../api/api-security-patterns/playbook.en.md).
...
- For deeper API-specific webhook, GraphQL, SOAP/XML, and gRPC controls, cross-check the [API security playbook](../../api/api-security-patterns/playbook.en.md). For browser rendering of uploaded or generated content, cross-check the [browser and frontend security playbook](../../web/browser-security/playbook.en.md).
...
Secure code can still violate business invariants. For sensitive flows, add this overlay and cross-check the [Business Logic Abuse playbook](../../business-logic/business-logic-abuse/playbook.en.md).
