...
- результаты SAST/DAST/SCA/IaC/container scans, pentest, incident history и данные из [плейбука управления уязвимостями](/Product-security-playbook/ru/review/vulnerability-management/playbook/);
